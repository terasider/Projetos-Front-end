...
function Loop(time = 2){
  ...
  */
  if(fome <= 0 || higiene <= 0 || sono <= 0 || diversao <= 0 || social <= 0){
     document.getElementById("pet").src="died.png";
     document.getElementById('mensagem').innerHTML = 'Você deixou seu pet morrer, atualize a página';
  }
  else if(total > 400){
     document.getElementById("pet").src="azul.png";
  }
  else if(total > 300){
     document.getElementById("pet").src="verde.png";
  }
  else if(total > 200){
     document.getElementById("pet").src="cinza.png";
  }
  else if(total > 100){
     document.getElementById("pet").src="amarelo.png";
  }
  else if(total > 50){
     document.getElementById("pet").src="vermelho.png";
  }
